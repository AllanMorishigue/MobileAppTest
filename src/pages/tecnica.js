...
export default class Tecnica extends React.Component{
  ...
  state = {
    ...
    renderizarFlat = ({item}) => {
        return (
			<View style={{backgroundColor: 'white', width: '97%', alignSelf: 'center', minHeight: 70, borderRadius: 30, marginTop: 10}}>
				<Text style={{fontWeight: 'bold', fontSize: 15, marginLeft: 20, marginTop: 5}}>{item.tecnica}</Text>
            ...
            <ScrollView style={{width: '95%', alignSelf: 'center', height: 340, marginTop: 10, marginBottom: 10}}>
                ...
                <View>
                    <View style={{width: '100%', marginTop: 10}}>
                        <TouchableOpacity onPress={() => navigation.replace('AddTecnica')}>
